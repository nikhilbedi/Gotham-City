...
public class WaiterRole extends Role implements Waiter {
    ...
    private enum CustomerState {waiting, leavingEarly, seated, readyToOrder, askedToOrder, gaveOrder, gaveOrderAndWaiting, waitingForFood, orderNotAvailable, eating, doneEating};
