...
import simcity.restaurants.restaurant3.src.restaurant.MarketRole;
...
public class RestaurantPanel extends JPanel implements ActionListener{
   ...
   // private WaiterAgent waiter = new WaiterAgent("waiter");
    ...
    private List<MarketRole> markets = Collections.synchronizedList(new Vector<MarketRole>());
...
public void actionPerformed(ActionEvent e) {
    	...
    	if (e.getSource() == pause) {	
    		if(!paused){
    			...
    			for(WaiterRole w: waiters) {
    				//w.getPersonAgent().restart();
    			}
    			//cook.getPersonAgent().restart();
    			//host.getPersonAgent().restart();
    			for(CustomerRole mc: customers){
    				//mc.getPersonAgent().restart();
    			}
    			//cook.restart();
    			//host.restart();
    			//paused = false;
