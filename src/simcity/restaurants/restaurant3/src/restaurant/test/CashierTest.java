package simcity.restaurant_evan.src.restaurant.test;

import simcity.restaurant_evan.src.restaurant.CashierRole;
import simcity.restaurant_evan.src.restaurant.CustomerRole;
import simcity.restaurant_evan.src.restaurant.Food;
import simcity.restaurant_evan.src.restaurant.MarketFood;
import simcity.restaurant_evan.src.restaurant.MarketOrder;
import simcity.restaurant_evan.src.restaurant.WaiterRole;
import simcity.restaurant_evan.src.restaurant.CashierRole.cashierBillState;
import simcity.restaurant_evan.src.restaurant.Order;
import simcity.restaurant_evan.src.restaurant.Order.OrderState;
import simcity.restaurant_evan.src.restaurant.WaiterRole.Bill;
import simcity.restaurant_evan.src.restaurant.test.mock.EventLog;
import simcity.restaurant_evan.src.restaurant.test.mock.MockCustomer;
import simcity.restaurant_evan.src.restaurant.test.mock.MockMarket;
import simcity.restaurant_evan.src.restaurant.test.mock.MockWaiter;
