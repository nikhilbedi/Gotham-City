...
public class Market extends Building {
	...
	public Market(String type, int entranceX, int entranceY, int guiX,
		...
		setJobRoles(jobs);
		Item beef = new Item("Beef", 10.99, 1000000);
		Item chicken = new Item("Chicken", 8.99, 1000000);
		Item rice = new Item("Rice", 6.99, 1000000);
		Item potato = new Item("Potato", 5.99, 1000000);
		Item pizza = new Item("Pizza", 5.99, 1000000);
		Item salad = new Item("Salad", 3.99, 1000000);
		Item steak = new Item("Steak", 10.99, 1000000);
	...
	public boolean isOpen() {
		if(CityClock.getDay() != 0 && CityClock.getDay() !=6) {
			if(CityClock.getTime() > weekdayOpen && CityClock.getTime() < weekdayClose) {
				if(marketCashier.checkWorkStatus() && marketWorker.checkWorkStatus())
					return true;
			}
		}
		else {
